...
ActiveRecord::Schema.define(version: 20150329180317) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "ad_buyers", force: :cascade do |t|
    t.integer  "ad_id"
    t.integer  "user_id"
    t.float    "price"
  ...
  add_index "ad_buyers", ["ad_id"], name: "index_ad_buyers_on_ad_id", using: :btree
  add_index "ad_buyers", ["user_id"], name: "index_ad_buyers_on_user_id", using: :btree
