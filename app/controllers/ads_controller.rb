class AdsController < ApplicationController
	...
	def create
		...
		@ad.lat 					= ad_params[:district_id] || @ad.user.district.lat unless @ad.user.district.nil?
		@ad.lng 					= ad_params[:district_id] || @ad.user.district.lon unless @ad.user.district.nil?
