class AdsController < ApplicationController
	...
	def create
		...
		@ad.lat 					= District.find_by(ad_params[:district_id]).lat || @ad.user.district.lat unless @ad.user.district.nil?
		@ad.lng 					= District.find_by(ad_params[:district_id]).lon || @ad.user.district.lon unless @ad.user.district.nil?
